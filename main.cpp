...
void customer_panel(sqlite3* db)
{
	...
	{
		cout<<"this is invalid input, please input 1 or 2 or 3  "<<endl;
		answer2 = int_eror<int>("this input is invalid , please input 1 or 2 or 3" );
	}
	...
	if ( answer2 == 1)
	{
		...
		while ( answer3 != 4)
		{
			if ( answer3 == 1)
			{
				...
				while (found == nullptr || found->get_exist() == false)
				{	
   					 if (found == nullptr)
        				cout << "Invalid ID. Try again.\n";
    				else
       					 cout << "This item is unavailable. Choose another.\n";
		...
		else if (answer == 6)
		{
			...
			while ( flagg == 0)
			{
				...
				for ( int i = 0; i<customers.size();i++)
				{
					...
					{
					cout<< " we dont have this user!, input the right id : "<<endl;
					}
				}
			...
			{
				cout<<" input 1 or 2 please "<<endl;
				manageranswer = int_eror<int>("this input is invalid !, please input number 2 or 1" );
			}
			if (manageranswer == 1)
			{
